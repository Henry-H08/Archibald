...
@onready var start: ParallaxBackground = $start
@onready var pew: Node2D = $pew
@onready var shadow: Sprite2D = $shadow
@onready var spell_display: Node2D = $spell_display
@onready var start_effect: CanvasLayer = $startEffect
@onready var start_effect_rect: ColorRect = $startEffect/startEffectRect
